    ...
    while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $view .='<div class="kakomi">';
            ...
            $view .='<div class="right">';
                ...
                $view .= '<img src="'.$result['img'].'" alt="" width="300px">';
            $view .='</div>';
            
            $view .='<div class="right">';
                $view .= '<a href="detail.php?id='.$result[id].'" class="btn">　修正　</a>'; //修正ボタン
                $view .= '<a href="delete.php?id='.$result[id].'" class="btn">　消去　</a>';//消去ボタン
